...
public static class GameText
{
    ...
    #region Credit Menu Text
    public static string Credits_Title = "Credits";
    public static string Credits_MadeBy = "Made By";
    public static string Credits_Developer = "Martyn Evans";
    ...
    public static string Paused_ReturnToMenu = "Main Menu";
